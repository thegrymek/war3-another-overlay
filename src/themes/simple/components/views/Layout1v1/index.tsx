...
//
// Layout for playing 1v1
// In game only data data from you is given. No data about enemy
//
...
//
// Layout for watching replays or being obs
// Here we have data about both sides: us and enemy
//
